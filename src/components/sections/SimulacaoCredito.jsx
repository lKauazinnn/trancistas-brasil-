  ...
  return (
    <section id="simulacao" style={{ background: 'var(--bg-secondary)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="section-padding max-w-7xl mx-auto">
        ...
        <ScrollReveal variant="fade-up">
          <p className="label-tag mb-3">Linha do Tempo — Conquistas da Profissão</p>
          <h3
            className="font-display font-black uppercase mb-10"
            style={{ fontSize: 'clamp(1.6rem, 3vw, 2.8rem)', color: 'var(--text-primary)' }}
          >
            Por séculos, o ofício<br />
            <span className="wood-text-gold">resistiu</span> sem reconhecimento.
          </h3>
        </ScrollReveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, width: '40px' }}>
                  <div
                    style={{
                      ...
                      background: item.destaque ? item.cor : 'var(--bg-surface)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      flexShrink: 0,
                    }}
                  >
                    {item.destaque
                      ? <CheckCircle size={16} color="#FAFAF5" strokeWidth={2} />
                      : <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: item.cor, display: 'block' }} />
                    }
                  </div>
                </div>
        ...
        <ScrollReveal variant="fade-up">
          ...
          >
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--ouro)', marginBottom: '1rem' }}>
              Mas trancistas ainda lutam por…
            </p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {AINDA_LUTAM.map((item, i) => (
                <span
                  key={i}
                  style={{
                    fontFamily: "'Space Grotesk', sans-serif",
        ...
        <ScrollReveal variant="fade-up">
          <div style={{ paddingTop: '1.5rem', borderTop: '1px solid var(--border)' }}>
            ...
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.72rem', color: 'var(--text-muted)', lineHeight: 1.7 }}>
              Ministério do Trabalho e Emprego — CBO das trancistas
              <br />
              Portal da Classificação Brasileira de Ocupações (CBO)
            </p>
          </div>
        </ScrollReveal>
